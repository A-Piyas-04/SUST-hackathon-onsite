...
def generate():
    ...
    for i in range(60):
        ...
        d.add('liquidity_signals',liquidity_signal_id=sid('signal',i),liquidity_projection_id=pid,signal_code='burn_rate',label='Observed synthetic burn rate',numeric_value=money(burn),unit='BDT/hour',direction='down' if burn>0 else 'stable',details=jd({'samples':12+i%37,'synthetic':True}),display_order='1')
